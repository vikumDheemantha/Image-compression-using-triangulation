...
newImg = decodeImage(encodedImage, size)
# print(encodedImage)
now = time.time() - start
...
print("size of the decoded: ", sys.getsizeof(encodedImage))
# print("MSE: ", mse)
...
pickle.dump(encodedImage,outfile)
outfile.close()
...
textOut.write("Size of decoded image: "+str(sys.getsizeof(encodedImage)) + "\n")
